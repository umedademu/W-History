...
for(const name of ["timur-story","timur-after-story","safavid-story","ottoman-story"]){if(!catalog.includes(`href="/${name}.html"`))throw new Error(`教材の入口がありません: ${name}`);}
...
collectImages(characterScenes,"timur");collectImages(afterScenes,"timur-after");collectImages(safavidScenes,"safavid");collectImages(ottomanScenes,"ottoman");
...
console.log(`構文・参照先${references}件・場面で使う画像${images.size}点・4教材の入口・Ankiからの独立・Vercel設定を確認しました。`);
