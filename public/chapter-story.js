import {series,volumeNavigation} from './story-volumes.js?v=0.068';
...
const {chapterEdition,chapterPlaces}=await import('./chapter-'+String(volume.chapter).padStart(2,'0')+'-edition.js?v=0.068');
