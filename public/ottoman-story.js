...
import { mapNamePlan, renderMapNameConcepts, entityNameForNarrative } from "./map-name-coverage.js?v=0.051";
...
import {project,worldMap,createOrientation,transitionFor} from "./ottoman-orientation.js?v=0.051";
