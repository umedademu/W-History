...
export const entities = {
  ...
  timur: person("ティムール", [65,40], "timur-march"), mehmed1: person("メフメト1世", "edirne"), murad2: person("ムラト2世", "edirne"),
  ...
  sigismund: person("ジギスムント", "buda", undefined, ["ハンガリー王ジギスムント"]), charles: person("カール5世", [8,49]), francis: person("フランソワ1世", [2.35,48.86]),
  sinan: person("建築家スィナン", "istanbul", undefined, ["スィナン","ミマール＝シナン"]), selim2: person("セリム2世", "istanbul"),
  philip: person("フェリペ2世", [-3.7,40.4]), sobieski: person("ヤン3世ソビエスキ", [19.94,50.06]), ahmed: person("アフメト3世", "istanbul", "ahmed-calm"),
  mongols: symbol("モンゴル軍", [44,40], "cavalry", ["モンゴル"]), rum: state("ルーム＝セルジューク朝", [33,38.4]),
  beyliks: symbol("ベイリク（小国家群）", [31,38], "town", ["ベイリク","小国家","小領邦"]),
  ghazis: symbol("トルコ人戦士（ガーズィー）", [29,39], "army", ["トルコ人戦士","トルコ人のイスラーム戦士","イスラーム戦士","戦士集団","ガーズィー"]),
  ottoman: state("オスマン朝", "sogut", ["オスマン帝国"]), byzantine: state("ビザンツ帝国", "istanbul", ["ビザンツ","東ローマ帝国","ローマ帝国"]),
  ottomanArmy: symbol("オスマン軍", "edirne", "army"), christian: symbol("キリスト教徒の戦士", "bursa", "army", ["キリスト教徒"]),
  slavs: symbol("スラヴ連合軍", [19,44], "army", ["スラヴ軍"]), crusaders: symbol("ヨーロッパ連合十字軍", "buda", "army", ["連合十字軍","十字軍"]),
  nobles: symbol("アナトリアの旧君侯", [35,38.5], "person", ["旧君侯"]), heirs: symbol("後継者たち", "bursa", "person", ["後継者"]),
  residents: symbol("住民", "edirne", "person"), jurists: symbol("イスラーム法学者", "edirne", "scroll"),
  boys: symbol("キリスト教徒の少年", [23,42], "child"), janissaries: symbol("イェニチェリ", "edirne", "army"),
  devshirme: symbol("デヴシルメ制", "edirne", "scroll"), officials: symbol("官僚・将軍・大宰相", "edirne", "person", ["官僚","将軍","宰相","大宰相"]),
  sipahi: { ...symbol("スィパーヒー", "bursa", "cavalry", ["シパーヒー"]), image:"sipahi-cavalry" },
  qizilbash: symbol("キジルバシュ騎兵", "tabriz", "cavalry", ["キジルバシュ"]), qadi: symbol("裁判官カーディー", [40,39], "scroll", ["カーディー"]),
  safavid: state("サファヴィー朝（シーア派）", "tabriz", ["サファヴィー朝","シーア派"]), mamluk: state("マムルーク朝", "cairo"),
  crimea: state("クリミア＝ハン国", "crimea", ["クリミア"]), abbasid: symbol("カイロのアッバース家", "cairo", "person", ["アッバース家"]),
  sunni: symbol("スンナ派の聖都保護", "mecca", "scroll", ["スンナ派"]), caliph: symbol("スルタン＝カリフ制の主張", "istanbul", "scroll", ["スルタン＝カリフ制","カリフ位"]),
  millet: symbol("ミッレット制（宗教別共同体）", "istanbul", "scroll", ["ミッレット制","ミッレット","宗教別共同体"]),
  jewish: symbol("ユダヤ人商人", [-3.7,40.4], "merchant", ["ユダヤ人","ユダヤ教徒","ユダヤ"]),
  greek: symbol("ギリシア人商人", [23,38], "merchant", ["ギリシア人"]), armenian: { ...symbol("アルメニア人商人", "istanbul", "merchant", ["アルメニア人","アルメニア商人","アルメニア"]), image:"armenian-merchant" },
  tax: symbol("税の納入", "istanbul", "coin", ["税納入","徴税"]), leaders: symbol("共同体の宗教指導者", "istanbul", "person", ["首長"]),
  habsburg: state("ハプスブルク家・神聖ローマ帝国", [13,48], ["ハプスブルク家","ハプスブルク","神聖ローマ帝国","神聖ローマ皇帝"]),
  hungarianArmy: symbol("ハンガリー王と軍", "mohacs", "army", ["ハンガリー王"]),
  ottomanFleet: { ...symbol("オスマン海軍", [26,36], "fleet", ["オスマン艦隊"]), image:"ottoman-galley" },
  allianceFleet: symbol("連合艦隊", [18,37], "fleet", ["神聖同盟連合艦隊"]), holyLeague: symbol("神聖同盟諸国", "vienna", "army", ["神聖同盟"]),
  walls: symbol("テオドシウスの二重城壁", [28.948,41.015], "wall", ["テオドシウス","二重城壁","城壁","要塞"]),
  goldenHorn: geo("金角湾", [28.965,41.04]), chain: symbol("金角湾の鉄の鎖", [28.985,41.029], "chain", ["鉄の鎖"]),
  defenders: symbol("ビザンツ守備軍", [28.975,41.015], "army"),
  ...
  hagia: symbol("ハギア＝ソフィア", [28.980,41.0085], "church", ["大聖堂"]),
  ...
  capitulation: symbol("カピチュレーション", "istanbul", "scroll", ["通商特権","領事裁判権"]),
  frenchMerchants: symbol("フランス商人", [5.37,43.3], "merchant"), sharia: symbol("シャリーア（イスラーム法）", "istanbul", "scroll", ["シャリーア","イスラーム法"]),
  kanun: symbol("カーヌーン（世俗法典）", "istanbul", "scroll", ["カーヌーン","世俗法典","法典"]),
  timar: symbol("ティマール制", "bursa", "scroll", ["ティマール"]), iltizam: symbol("徴税請負制（イルティザーム）", "bursa", "coin", ["徴税請負制","イルティザーム"]),
  ayan: symbol("地方有力者（アーヤーン）", [32,39], "person", ["アーヤーン","地方有力者"]),
  treasury: symbol("帝国の財政", "istanbul", "coin", ["軍事費","財政難","インフレ"]),
  treaty: symbol("カルロヴィッツ条約", "karlowitz", "scroll"),
  tulip: { ...symbol("チューリップ", "istanbul", "flower", ["チューリップ時代"]), image:"tulip-flower" },
  press: symbol("印刷機", "istanbul", "press"), baroque: symbol("西欧風バロック建築", "istanbul", "palace", ["バロック建築"]),
  industry: symbol("産業革命", [-1.9,52.5], "factory"),
};
...
export const storyboards = {
  ...
  istanbul: [
    ...
    step("ハギア＝ソフィアをモスクへ", "同じ建物がキリスト教の大聖堂からモスクへ用途を変え、帝国の宗教的中心の一つとなります。", ["istanbul","hagia","mehmed"], {frame:[28.94,40.995,29.02,41.04],detail:"city",afterIcons:{hagia:"mosque"},badges:{hagia:"大聖堂 → モスク"},note:"建物の記号の変化は、大聖堂からモスクへの用途変更を示します。"}),
  ...
  millet: [
    ...
    step("納税と宗教共同体の自治", "キリスト教徒やユダヤ教徒の共同体が税を納め、宗教指導者を通じて信仰・婚姻・裁判などの自治を保ちます。", ["istanbul","christian","jewish","millet","tax","leaders"], {labels:{christian:"キリスト教徒の共同体",jewish:"ユダヤ教徒の共同体"},icons:{christian:"person"},positions:{christian:[27.5,41],jewish:[30.5,41],leaders:[29,40.2]},moves:[move("tax",[[30.5,41],"istanbul"],"trade")],note:"共同体は各地に存在しました。図はイスタンブル周辺にまとめた制度の模式図です。"}),
