...
export const scenes = [
  scene({
    ...
    title: "アナトリア西北部に、\nオスマン朝が誕生する。",
    body: [
      "13世紀、モンゴルの遠征によってルーム＝セルジューク朝が弱体化し、やがて解体すると、アナトリア各地にトルコ人戦士の小国家（ベイリク）が乱立した。",
  ...
  scene({
    ...
    body: [
      ...
      "1538年の<strong>プレヴェザの海戦</strong>で、バルバロス率いるオスマン海軍は、スペイン・ヴェネツィア・ローマ教皇の連合艦隊を撃破。地中海で海軍の優位を強めた。"
    ],
  ...
  scene({
    ...
    title: "カピチュレーションと、\n法・文化の成熟。",
    body: [
      "スレイマン1世は対ハプスブルクで連携したフランスに対し、領事裁判権や免税を含む通商特権<strong>カピチュレーション</strong>を付与した。これは後にイングランド・オランダなどへも広がり、東西貿易の活況を生んだ。",
  ...
  scene({
    ...
    body: [
      ...
      "これを機に結成された神聖同盟諸国との長期戦に敗れ、1699年の<strong>カルロヴィッツ条約</strong>で、オスマン帝国は<strong>ハンガリーの大部分などをオーストリアに割譲</strong>した。帝国の領土縮小時代の幕開けとなった。"
    ],
