import { places, zones, scenes } from "./regional-dynasties-scenes.js?v=0.005";
...
const resolveImg = key => key.includes("/") ? `/images/${key}.png` : `/images/regional-dynasties/${key}.png`;
