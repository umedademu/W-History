...
地図と物語で世界史の流れを学ぶ、クリックで進む紙芝居教材です。現在の版は **v0.010** です。
...
入口は `/` の教材一覧です。前後ボタン、左右キー、章・場面番号から移動できます。音声と自動の場面送りはありません。07では、同じ場面の中の短い地図説明を順に再生し、一時停止や本文の名前からの見直しができます。端末の「動きを減らす」設定では結果を静止表示します。
