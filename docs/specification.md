...
現在の版は v0.033（2026年9月7日）。中東史全9編、合計233場面、場面で使う画像163点を収録しています。参考書全33枚の情報を完全に書き起こした資料集（sourcesフォルダ・全5編＋対照表）を整理し、保管しています（公開管理からは除外）。
