...
現在の版は v0.001（2026年9月5日）。教材3本、合計49場面、画像66点を収録しています。

## 公開ファイル

- `public/index.html`：3教材を選ぶ一覧。
...
- `public/images/timur/`、`timur-after/`、`safavid/`：透過画像。18点・22点・26点。

各教材は独立したHTMLのまま維持し、教材一覧と相互リンクから開きます。地図のSVGは維持し、人物・建物・道具にはPNG画像を使います。前後ボタン・左右キー・章・場面番号・動きの再表示に対応します。

## 編集と確認

内容の構成は [遠征](timur-story.md)、[死後](timur-after-story.md)、[サファヴィー朝](safavid-story.md) を参照してください。画像の記録は各 `*-images.md` にあります。
